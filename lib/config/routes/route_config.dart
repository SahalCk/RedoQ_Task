...
import 'package:redoq/presentation/main_section/update_user_details_section/views/screens/update_user_details_screen.dart';
import 'package:redoq/presentation/main_section/view_users_section/views/screens/view_users_details_screen.dart';
import 'package:redoq/presentation/onboarding_section/splash_screen_section/views/screens/splash_screen.dart';
import 'package:redoq/utils/transitions/screen_transitions.dart';

class RedoqRouteConfig {
  static final routeConfig =
      GoRouter(initialLocation: '/viewUsersDetails', routes: [
    GoRoute(
